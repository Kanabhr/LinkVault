...
const getpubliclinks = (username, page = 1, limit = 10) => axiosService.get(`/users/u/${username}/public?page=${page}&limit=${limit}`);
const getusertags = () => axiosService.get("/users/usercustomtags")
const getuserlinks = () => axiosService.get("/users/userprofile");
export { savelink, editlink, edittag, deletelink, deletetag, getuserlinks, getpubliclinks ,getusertags};
